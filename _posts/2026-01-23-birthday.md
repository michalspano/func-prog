...
12-hour schedule this time (he typically has an alarm set to 8AM).
...
*Italian* afterwards, the sequence becomes e.g. `WWBWL`. Then he receives $2*2
+ 2 + 1 + 2$, where the last $2$ is the bonus which he didn't want to miss.
